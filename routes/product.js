...
///////////// look for more products functionality in admin/adminauth.js
// router.post('/addproduct', [
//     body('name', 'Enter a valid name').exists(),
//     body('brand', 'Enter a valid brand').exists(),
//     body('price', 'Enter a valid price').isFloat({min:1}),
// ], async (req, res) => {
...
//             name, brand, price, category, image, rating, type, author, description, gender
//         });
//         success = true
//         res.status(201).send({ success, msg: "Added Product", product })
//     }
//     catch (error) {
...
//////////////////// type (cloth, shoe...) and category (all, running, walking....)
